...
from wand.image import Image as Meowimage

from .utils import _Meowutils
...
async def Meow_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def Meow_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = Meowimage(filename=picture_name)
    main_image.resize(
